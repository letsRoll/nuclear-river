...
namespace NuClear.CustomerIntelligence.Querying.Tests
{
    ...
    internal class MetadataTests
    {
        ...
        [TestCase("CustomerIntelligence/StoreModel/Aggregates.CategoryGroup")]
        [TestCase("CustomerIntelligence/StoreModel/Aggregates.Client")]
        [TestCase("CustomerIntelligence/StoreModel/Aggregates.ClientContact")]
        [TestCase("CustomerIntelligence/StoreModel/Aggregates.FirmView")]
        [TestCase("CustomerIntelligence/StoreModel/Aggregates.FirmBalance")]
        [TestCase("CustomerIntelligence/StoreModel/Aggregates.FirmCategory1")]
        [TestCase("CustomerIntelligence/StoreModel/Aggregates.FirmCategory2")]
        [TestCase("CustomerIntelligence/StoreModel/Aggregates.FirmCategory3")]
        [TestCase("CustomerIntelligence/StoreModel/Aggregates.Project")]
        [TestCase("CustomerIntelligence/StoreModel/Aggregates.ProjectCategory")]
        [TestCase("CustomerIntelligence/StoreModel/Aggregates.Territory")]
